...
class WebCrawlerIntegration(ToolIntegration):
    """Basisklasse für Web Crawler Integrationen."""
    
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        """
        Initialisiert die Web Crawler Integration.
    ...
    def run(self, target: str, options: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
        Führt den Web Crawler mit den angegebenen Optionen aus.
        
        Args:
            target: Die Ziel-URL oder Domain.
            options: Zusätzliche Optionen für den Web Crawler.
    ...
    def get_results(self) -> Dict[str, List[str]]:
        """
        Gibt die Ergebnisse des Web Crawlers zurück.
...
class GospiderIntegration(WebCrawlerIntegration):
...
class HakrawlerIntegration(WebCrawlerIntegration):
...
class WebCrawlerFactory:
    ...
    @staticmethod
    def create(crawler_type: str, config: Dict[str, Any]) -> WebCrawlerIntegration:
        """
